...
void ui_SP1P9HScorecard_screen_init(void)
{
    ...
    lv_obj_set_style_border_color(ui_SP1P9HScorecard, lv_color_hex(0x00EE49), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_remove_flag(ui_SP1P9HScMMBText,
                       ...
                       LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_text_color(ui_SP1P9HScMMBText, lv_color_hex(0x00F46A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_remove_flag(ui_SP1P9HScBBText,
                       ...
                       LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_text_color(ui_SP1P9HScBBText, lv_color_hex(0x00F46A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_SP1P9HScPSCrown = lv_image_create(ui_SP1P9HScorecard);
    lv_image_set_src(ui_SP1P9HScPSCrown, &ui_img_crown_resized_png);
    lv_obj_set_width(ui_SP1P9HScPSCrown, LV_SIZE_CONTENT);   /// 83
    lv_obj_set_height(ui_SP1P9HScPSCrown, LV_SIZE_CONTENT);    /// 46
    lv_obj_set_x(ui_SP1P9HScPSCrown, 717);
    lv_obj_set_y(ui_SP1P9HScPSCrown, 225);
    lv_obj_set_align(ui_SP1P9HScPSCrown, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_SP1P9HScPSCrown, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_remove_flag(ui_SP1P9HScPSCrown,
                       LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE |
                       LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
