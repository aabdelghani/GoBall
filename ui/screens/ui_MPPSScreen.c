...
void ui_MPPSScreen_screen_init(void)
{
    ...
    lv_obj_set_style_border_color(ui_MPPSScreen, lv_color_hex(0x00EE49), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_image_set_src(ui_MPPSSLogo, &ui_img_studio_go_ball_logo_350x319_png);
    lv_obj_set_width(ui_MPPSSLogo, LV_SIZE_CONTENT);   /// 350
    lv_obj_set_height(ui_MPPSSLogo, LV_SIZE_CONTENT);    /// 337
    lv_obj_set_x(ui_MPPSSLogo, 0);
    lv_obj_set_y(ui_MPPSSLogo, 120);
    ...
    lv_image_set_src(ui_MPPSFormat, &ui_img_go_ball_300x273_png);
    lv_obj_set_width(ui_MPPSFormat, LV_SIZE_CONTENT);   /// 300
    lv_obj_set_height(ui_MPPSFormat, LV_SIZE_CONTENT);    /// 287
    lv_obj_set_x(ui_MPPSFormat, -300);
    lv_obj_set_y(ui_MPPSFormat, -160);
    ...
    lv_obj_remove_flag(ui_MPPSFText, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                       LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_text_color(ui_MPPSFText, lv_color_hex(0x00F46A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_MPPSFText, &ui_font_Unitblock_72, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MPPSBButton = lv_image_create(ui_MPPSScreen);
    lv_image_set_src(ui_MPPSBButton, &ui_img_go_ball_300x273_png);
    lv_obj_set_width(ui_MPPSBButton, LV_SIZE_CONTENT);   /// 300
    lv_obj_set_height(ui_MPPSBButton, LV_SIZE_CONTENT);    /// 287
    lv_obj_set_x(ui_MPPSBButton, 300);
    lv_obj_set_y(ui_MPPSBButton, -160);
    ...
    lv_obj_remove_flag(ui_MPPSBBText, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                       LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_text_color(ui_MPPSBBText, lv_color_hex(0x00F46A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_MPPSBBText, &ui_font_Unitblock_72, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MPPS1V1Button = lv_image_create(ui_MPPSScreen);
    lv_image_set_src(ui_MPPS1V1Button, &ui_img_go_ball_450x431_png);
    lv_obj_set_width(ui_MPPS1V1Button, LV_SIZE_CONTENT);   /// 450
    lv_obj_set_height(ui_MPPS1V1Button, LV_SIZE_CONTENT);    /// 431
    lv_obj_set_x(ui_MPPS1V1Button, -700);
    lv_obj_set_y(ui_MPPS1V1Button, 85);
    ...
    lv_obj_set_y(ui_MPPS1V1BText, 19);
    ...
    lv_obj_remove_flag(ui_MPPS1V1BText, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                       LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_text_color(ui_MPPS1V1BText, lv_color_hex(0x00F46A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_MPPS1V1BText, &ui_font_Unitblock_72, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_MPPS2V2Button = lv_image_create(ui_MPPSScreen);
    lv_image_set_src(ui_MPPS2V2Button, &ui_img_go_ball_450x431_png);
    lv_obj_set_width(ui_MPPS2V2Button, LV_SIZE_CONTENT);   /// 450
    lv_obj_set_height(ui_MPPS2V2Button, LV_SIZE_CONTENT);    /// 431
    lv_obj_set_x(ui_MPPS2V2Button, 700);
    lv_obj_set_y(ui_MPPS2V2Button, 85);
    ...
    lv_obj_set_x(ui_MPPS2V2BText, 1);
    lv_obj_set_y(ui_MPPS2V2BText, 2);
    ...
    lv_obj_remove_flag(ui_MPPS2V2BText, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                       LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_text_color(ui_MPPS2V2BText, lv_color_hex(0x00F46A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_MPPS2V2BText, &ui_font_Unitblock_72, LV_PART_MAIN | LV_STATE_DEFAULT);
